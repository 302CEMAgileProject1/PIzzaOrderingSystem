...
class LoginTest extends TestCase
{
    ...
    // Below is to test whether login page exists by entering the page and finding the word "Login"
    ...
    // Below is to test an attempt to login to the website. The HTTP request code 302 means that it must redirect to a next page once test passes.
    ...
    // Below is to test whether the user can view the login form when authenticated
    ...
    // Below is to test whether the user can login when using correct credentials
